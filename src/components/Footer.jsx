          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 text-white'>
            ...
            <div>
              ...
              <p className='mt-4 text-white/75 text-sm leading-relaxed'>
                Guantes personalizados con precisión artesanal y materiales
                premium. Hechos por boxeadores, para boxeadores.
              </p>
            ...
            {/* Col 2: Navegación */}
            <nav>
              <h4 className='font-title uppercase tracking-wider2 text-white/90 text-lg'>
                Secciones
              </h4>
            ...
            <div>
              ...
              <ul className='mt-4 space-y-2 text-white/80 text-sm'>
                <li>
                  <a
                    href='mailto:hola@boxinggloves.com'
                    className='hover:text-brand-red'
                  >
                    hola@boxinggloves.com
                  </a>
                </li>
                <li>
                  <a href='tel:+34999999999' className='hover:text-brand-red'>
                    +34 999 999 999
                  </a>
                </li>
                <li>Madrid, España</li>
